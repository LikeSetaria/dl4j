 ...
 */
public class SelectKPropIdex {
    public SelectKPropIdex(String u_data_name,String another_U_dataName) {
...
//        normalizer2.transform(anotherUallData);
        ...
        for(DataSet d:UallData){
             U_datasetList.add(d);
 //System.out.println(m+" 行号"+d.getLabels());
        }
